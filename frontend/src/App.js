    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {activeTab === 'evaluate' && (
          ...
          {activeTab === 'adaptive' && (
            <AdaptiveThresholdInterface backendUrl={BACKEND_URL} />
          )}
          ...
          {activeTab === 'alignment' && (
            <div className="space-y-8 w-full">
              ...
              <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                <h2 className="text-2xl font-bold text-purple-800">AI Alignment Solution</h2>
                <p className="text-gray-700">
                  This workspace provides access to the core components of the AI alignment solution (90% complete):
                  data labeling with ethical vectors (50%) and model constitution via embedding statement (40%).
                </p>
              </div>
              
              {/* Tab Navigation for Alignment Components */}
              <div className="bg-white rounded-lg shadow overflow-hidden">
                <div className="flex border-b">
                  <button
                    onClick={() => setActiveResultTab('ml-data')}
                    className={`flex-1 px-4 py-3 text-center font-medium ${
                      activeResultTab === 'ml-data'
                  ...
                  <button
                    onClick={() => setActiveResultTab('constitution')}
                    className={`flex-1 px-4 py-3 text-center font-medium ${
                      activeResultTab === 'constitution'
                        ? 'bg-purple-50 text-purple-700 border-b-2 border-purple-600'
                        : 'text-gray-600 hover:text-gray-800 hover:bg-purple-50'
                    }`}
                  >
                ...
                <div className="p-6">
                  {activeResultTab === 'ml-data' && (
                    <MLDataPreparation backendUrl={BACKEND_URL} />
                  )}
